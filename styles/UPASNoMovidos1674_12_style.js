...
var style_UPASNoMovidos1674_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFill = "#74ff36";
    var bufferColor = "#000004";
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("Estado") !== null && resolution > 0 && resolution < 2) {
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.8 + size, points: 5,
            radius2: 4.4, displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(176,255,60,1.0)'})}),
